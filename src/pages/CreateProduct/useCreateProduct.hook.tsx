...
/* props */
import { CreateProductFormSchema, CreateProductFormValues } from './CreateProduct.props';
/* hooks */
...
export function useCreateProduct() {
    ...
    const createProductFields: FieldProps[] = [
        nameFieldProps,
        categoryFieldProps,
        expiresFieldProps,
        stockFieldProps,
    ...
    return { handleCreateProduct, createProductFields };
}
